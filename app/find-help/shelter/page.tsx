    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-4xl font-extrabold text-slate-900">{tr.shelter.title}</h1>
        </div>
        <p className="text-xl text-slate-600 max-w-2xl leading-relaxed">{tr.shelter.subtitle}</p>
      </div>
      ...
      <div className="bg-amber-50 border-l-4 border-amber-500 rounded-r-xl p-4 mb-8">
        <p className="text-amber-900 font-semibold text-base">
          ⚠️ Shelter availability changes daily. Always call ahead or text <strong>211</strong> for current openings.
        </p>
      </div>
