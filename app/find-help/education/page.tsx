    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-4xl font-extrabold text-slate-900">{tr.education.title}</h1>
        </div>
        <p className="text-xl text-slate-600 max-w-2xl leading-relaxed">{tr.education.subtitle}</p>
      </div>
